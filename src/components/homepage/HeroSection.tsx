...
export default function HeroSection() {
  return (
    <>
      ...
      <div className="pt-[46px] pb-[132px] lg:pt-6 lg:px-[160px] lg:mt-32 lg:grid lg:grid-cols-12">
        <div className="lg:col-span-6 lg:row-start-1 lg:pt-6">
          <h1 className="text-lg lg:text-[50px] lg:leading-[110%] lg:tracking-[1px]">
        ...
        <div className="lg:col-start-9 lg:col-span-4 lg:max-h-[512px] lg:max-w-[512px] lg:row-start-1 xl:ml-0">
          <VoidCard />
        </div>
        <div className="pt-16 lg:col-span-12 lg:mt-9 lg:pt-0">
          <SummaryMetrics />
        </div>
      </div>
    </>
