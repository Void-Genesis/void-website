        ...
        <div className="lg:flex lg:flex-col lg:py-44 lg:px-40">
          ...
          <div className="lg:flex lg:flex-row lg:gap-20">
            ...
            <div className="lg:w-1/2">
              <h1 className="lg:font-sora lg:text-[42px] lg:font-extrabold lg:leading-[120%] lg:tracking-[1px]">Soluções Sob Medida para Seu Sucesso</h1>
            ...
            <div className="lg:w-1/2 relative">
              ...
              <img className="h-8 hidden lg:absolute lg:flex lg:right-0 lg:top-0" src="/logo-void-white.svg" alt="Void Genesis" />
          ...
          <div className="lg:mt-11">
            ...
            <div id="buttons" className="flex flex-row justify-center items-center gap-12">
              <div>
                <img className="rotate-180 w-8 cursor-pointer" src="/icon-chevron-r.svg" alt="Void Genesis" />
              </div>
              <div>
                <img className="w-8 cursor-pointer" src="/icon-chevron-r.svg" alt="Void Genesis" />
              </div>
            </div>
          </div>
        </div>
