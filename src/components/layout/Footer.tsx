...
export default function Footer() {
  return (
    <div className="px-[16px] pt-[46px] pb-[132px] lg:py-[148px] lg:px-[160px]">
      <div className="px-4 py-[52px] lg:px-[52px] border border-void-grey-800 rounded-[2px]">
        <div className="flex flex-col p-2 gap-12 lg:flex-row lg:gap-16 xl:gap-5 lg:items-center lg:justify-between">
          ...
          <div className="">
            <h1 className="text-void-white pb-5 text-center font-normal text-2xl leading-[120%] tracking-[0.18px] lg:text-left lg:text-lg">
              Entre em contato
            </h1>
