...
export default function Header() {
  return (
    <>
      <nav className="flex flex-row justify-between bg-[#131418] p-6 border-b-[1px] border-void-grey-400 lg:mx-96 lg:rounded-[4px] lg:border lg:border-void-grey-400 lg:py-4 lg:mt-6 lg:fixed lg:top-0 lg:left-0 lg:right-0 lg:z-10">
